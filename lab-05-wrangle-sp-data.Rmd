...
***There are 3 pairings between all Denny's and La Quinta locations in Alaska, so we need to calculate 6 distances between the locations.***
...
***There are `r nrow(dn_lq_ak)` observations. There names are `r names(dn_lq_ak)`.***
...
***Not all Denny's locations and La Quita locations are near each other. in New York, the mean distance between a Denny's and a La Quita is 33.5745 miles. In North Carolina, the mean distance between a Denny's and a La Quita is 65.44432 miles.***
